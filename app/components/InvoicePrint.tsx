      ...
      <div className="hidden print:block">
        ...
        <div ref={ref} className="p-12 w-[210mm] h-[297mm] box-border overflow-hidden mx-auto bg-white font-sans text-slate-900 leading-normal relative">
          ...
          <div className="mb-12 bg-slate-50 p-6 rounded-xl border border-slate-100">
            <h3 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-4 border-b border-slate-200 pb-2">Concerne</h3>
            <div className="flex gap-16">
              <div>
                <p className="text-[10px] text-slate-400 font-bold uppercase mb-1 tracking-wider">Appareil</p>
                <p className="font-bold text-lg text-slate-900">{repairDetails.brandModel}</p>
          ...
          <table className="w-full mb-12 border-collapse">
            ...
            <tbody>
              <tr className="border-b border-slate-100">
                ...
                <td className="py-5 px-4 text-right text-slate-500 font-medium">{invoice.vatRate}%</td>
                <td className="py-5 px-4 text-right font-bold text-slate-700">{euro(invoice.laborAmount)}</td>
              </tr>
              <tr className="border-b border-slate-100">
                <td className="py-5 px-4">
                ...
                <td className="py-5 px-4 text-right text-slate-500 font-medium">{invoice.vatRate}%</td>
                <td className="py-5 px-4 text-right font-bold text-slate-700">{euro(invoice.partAmount)}</td>
              </tr>
            </tbody>
          </table>
          ...
          <div className="flex justify-end mb-10">
            <div className="w-80">
              ...
              <div className="flex justify-between py-4 bg-slate-100 rounded-xl px-5 mt-4 shadow-sm border border-slate-200">
                <span className="text-lg font-black uppercase text-slate-800">Total TTC</span>
                <span className="text-xl font-black text-indigo-600">{euro(invoice.totalTtc)}</span>
              </div>
            </div>
          </div>

          {/* Pied de page absolu */}
          <div className="absolute bottom-10 left-12 right-12 text-center text-xs text-slate-400 pt-6 border-t border-slate-200">
            <p className="mb-2 font-bold tracking-wide text-slate-500">Merci de votre confiance ! Vos réparations sont garanties 6 mois.</p>
