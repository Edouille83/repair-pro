...
import { User, Wrench, ClipboardList, FileText, Plus, Minus, Smartphone, Mail, Trash2, CheckCircle2 } from "lucide-react";
          ...
          <div className="bg-white rounded-xl p-5 shadow-sm border border-slate-200">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <input type="time" value={heure} onChange={e => setHeure(e.target.value)} className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all" />
              </div>
            </div>
            <div>
